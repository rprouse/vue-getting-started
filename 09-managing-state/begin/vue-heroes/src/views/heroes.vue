...
import { GET_HEROES_ACTION, DELETE_HERO_ACTION } from '../store/action_types';
...
export default {
  ...
  methods: {
    ...mapActions([GET_HEROES_ACTION, DELETE_HERO_ACTION]),
    askToDelete(hero) {
  ...
  computed: {
    ...
    // },
    //...mapState({heroes: state => state.heroes}), // This is the same as above
    //...mapState({ heroes: 'heroes' }), // And this is even simpler
    ...mapState(['heroes']), // And simpler yet
    modalMessage() {
      const name =
